        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-8">
                        <p class="text-center">
                            <strong>Thống kê sản phẩm: {{ now()->format('d/m/Y') }}</strong>
                        </p>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="progress-group">
                            ...
                            <span class="float-right"><b>{{ $totalProducts ?? 0 }}</b>/{{ $goal ?? 0 }}</span>
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-primary" style="width: {{ $percent ?? 0 }}%"></div>
                            </div>
                        </div>
                        ...
                        <div class="progress-group">
                            Sản phẩm hết hàng
                            @php
                                // Sử dụng collect([]) nếu $products chưa tồn tại để tránh lỗi gọi hàm trên null
                                $currentProducts = $products ?? collect([]);
                                $outOfStock = $currentProducts->where('quatity', 0)->count();
                            @endphp
                            <span class="float-right"><b>{{ $outOfStock }}</b>/{{ $totalProducts ?? 0 }}</span>
                            <div class="progress progress-sm">
                                <div class="progress-bar bg-danger"
                                    style="width: {{ ($totalProducts ?? 0) > 0 ? ($outOfStock / ($totalProducts ?? 1)) * 100 : 0 }}%">
                                </div>
                            </div>
                        </div>
                        <!-- /.progress-group -->
